...
app.get('/', async (req, res) => {
  ...
  const href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${googleAuth.clientId}&redirect_uri=http://localhost:8081/oauth/success&response_type=code&scope=email`;
...
app.get('/oauth/success', async (req, res) => {
  ...
  const data = await fetch("https://oauth2.googleapis.com/token", {
    ...
    body: JSON.stringify({
      ...
      redirect_uri: 'http://localhost:8081/oauth/success'
    })
  });
